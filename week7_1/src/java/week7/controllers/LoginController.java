...
/**
 *
 * @author Jose Julio MANCHA HERNANDEZ
 */
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isValid == true) {
            ...
            String txtName = Database.getName();
            String txtApellidos = Database.getLastName();

            session.setAttribute("username", txtUsername);
            session.setAttribute("name", txtName);
            session.setAttribute("apellidios", txtApellidos);
